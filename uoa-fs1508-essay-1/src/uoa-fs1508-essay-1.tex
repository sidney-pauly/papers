...
% -- No clean shots: panning tilting, zooming

% \\



% Main cinematographic techniques employed and what they do to us:
% First person:
% Unsteady shots:
%   Here again "Suzhou River" differs a lot from other movies. Unsteady shots are usually used in action
%   scenes to heighten the tension and make the action seam more believable. In "Suzhou River" unsteady
%   shots shots are also used in calm scenes and for different reasons. For one the film is shot from
%   the first pearson perspective for the most part. From that a certain amount of shacking is expected
%   as the camera is just more unsteady as it's virtually "attached" to the main charecters 
% Zooming in:
% Limited view distance:
% Framing of the camera closing in:
% Shallow field of depth: 
% Camera angle towards the ground:
